...
- Carl: Former Product Designer with 10 years of recruiting experience, including 6 years at Meta (WhatsApp, Instagram, Enterprise). I leverage a personal database of 40,000+ design connections to find talent that isn't always active on the job boards. ([LinkedIn](https://www.linkedin.com/in/carlcwheatley/))
### How we support Reach Capital founders:
- Flexible Models: From full recruitment (retainer or contingency) to hourly portfolio reviews and hiring guidance.
- Vetting & Strategy: Helping founders who may not have a design background understand compensation bands, technical requirements (Figma/coding), and how to run a proper "work trial."
- High-Touch Collaboration: Since I’m based in Morgan Hill, I’m always available to meet with Bay Area-based founders in person to walk through their specific needs.
